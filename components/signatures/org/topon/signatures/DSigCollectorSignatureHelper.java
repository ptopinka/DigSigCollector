...
public class DSigCollectorSignatureHelper {
	
	public static String DIGITAL_SIGNATURE_ALGORITHM_NAME = "SHA1withRSA";
	
	public static Document createDSigColSignature( PrivateKey privKey, X509Certificate cert,String urlDocument) {
		Document doc = null;
	...
	public static boolean verifyDSigColSignature(Document doc) {
		boolean isOK = false;
